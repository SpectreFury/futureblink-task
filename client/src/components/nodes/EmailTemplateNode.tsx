...
const EmailTemplateNode = (props: EmailTemplateNodeProps) => {
  return (
    <div className="flex flex-col items-center border px-2 py-1 bg-gray-50 rounded cursor-pointer max-w-2xs relative">
